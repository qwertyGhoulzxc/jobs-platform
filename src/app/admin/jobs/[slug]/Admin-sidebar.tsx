...
export default function AdminSidebar({ job }: IAdminSidebarProps) {
  return (
...
function ApproveSubmissionButton({ jobId }: IAdminButtonProps) {
...
function DeleteJobButton({ jobId }: IAdminButtonProps) {
